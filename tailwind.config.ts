...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        card: "0 1px 3px 0 hsl(220 50% 12% / 0.06), 0 1px 2px -1px hsl(220 50% 12% / 0.06)",
        "card-hover": "0 4px 12px 0 hsl(220 50% 12% / 0.10), 0 2px 4px -2px hsl(220 50% 12% / 0.08)",
        "stat": "0 0 0 1px hsl(var(--border)), 0 2px 8px 0 hsl(220 50% 12% / 0.06)",
      },
      keyframes: {
